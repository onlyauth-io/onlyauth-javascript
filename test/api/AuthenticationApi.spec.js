...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onlyauth.AuthenticationApi();
  });
  ...
  describe('AuthenticationApi', function() {
    ...
    describe('validateSuccessToken', function() {
      it('should call validateSuccessToken successfully', function(done) {
        //uncomment below and update the code to test validateSuccessToken
        //instance.validateSuccessToken(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
